            ...
            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" class="form-control" readonly
						   ...
						   position: relative;
						   margin-left: 10px;"
                           value="${addressDelete[0].getId()}" />
                </div>
            </div>

            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" name="person" class="form-control" readonly
                           style="border-radius: 0px;
						   width: 550px;
						   position: relative;
						   margin-left: 10px;"
                           value="${addressDelete[0].getPerson()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" name="street" class="form-control" readonly
						   ...
						   position: relative;
						   margin-left: 10px;"
                           value="${addressDelete[0].getStreet()}" />
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" name="building" class="form-control" readonly
						   ...
						   position: relative;
						   margin-left: 10px;"
                           value="${addressDelete[0].getBuilding()}" />
                </div>
            </div>

            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" name="office" class="form-control" readonly
                           style="border-radius: 0px;
						   width: 550px;
						   position: relative;
						   margin-left: 10px;"
                           value="${addressDelete[0].getOffice()}" />
                </div>
            </div>
