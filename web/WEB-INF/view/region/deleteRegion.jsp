...
<div class="container-fluid">
    ...
    <div class="container" id="container-form">
        <form method="POST" action="">
            ...
            <div class="row mb-3">
                <div class="col-sm-10">
                    <input type="text" name="region" class="form-control" placeholder="Регион" readonly
                           style="border-radius: 0px;
						   width: 550px;
						   position: relative;
						   margin-left: 10px;"
                           value="${regionDelete[0].getRegion()}" />
                </div>
            </div>

            <div class="col text-center">
                <button type="submit" class="btn btn-primary" id="btn-1">ОК</button>
                <a href='<c:url value="/region" />' role="button" id="btn-2" class="btn btn-secondary">Отменить/Возврат</a>
            </div>
        </form>
    </div>
</div>
