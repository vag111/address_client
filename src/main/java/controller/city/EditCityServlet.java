...
public class EditCityServlet extends HttpServlet {
    ...
    String EDIT_CITY = "UPDATE city SET regionId = ?, city = ? WHERE id = ?";

    ArrayList<City> cities = new ArrayList<>();
    ArrayList<City> editCity = new ArrayList<>();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = builder.getConnection()) {
            ...
            try (PreparedStatement preparedStatement = conn.prepareStatement(SELECT_CITY_BY_ID)) {
                ...
                if (rs != null) {
                    editCity.clear();
                    while (rs.next()) {
                        editCity.add(new City(rs.getLong("id"),
                                rs.getString("city"),
                                rs.getLong("regionId")));
                    }
                    rs.close();
        ...
        if("/editCity".equals(userPath)){
            request.getRequestDispatcher("/WEB-INF/view/city/editCity.jsp")
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = builder.getConnection()){
            ...
            PreparedStatement preparedStatement = conn.prepareStatement(EDIT_CITY);
